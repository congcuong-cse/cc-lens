...
if (!fs.existsSync(standaloneDir)) {
  console.error(`[cc-lens] .next/standalone not found. Did \`next build\` run with output: 'standalone'?`)
  process.exit(1)
}
...
console.log('[cc-lens] standalone bundle prepared at .next/standalone')
